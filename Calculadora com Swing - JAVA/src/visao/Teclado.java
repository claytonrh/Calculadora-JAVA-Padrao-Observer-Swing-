...
public class Teclado extends JPanel implements ActionListener {
	...
	private final Color COR_LARANJA = new Color(228, 160, 77);	
	...
	public Teclado () {	
		...
		// Linha 1
		c.gridwidth = 2;	// aqui determina a largura do próximo botão								
		adicionarBotao("AC", COR_CINZA_ESCURO, c, 0, 0);
		c.gridwidth = 1;	// aqui detremina a largura volte a ser 1 nos próximos botões
	...
	public void actionPerformed(ActionEvent e) { // esse metodo informa que uma ação foi executada/performada
